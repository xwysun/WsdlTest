...
public class COGImagingSettings20 extends AttributeContainer implements KvmSerializable
{

    
    public COGBacklightCompensation20 BacklightCompensation;
    ...
    public COGExposure20 Exposure;
    
    public COGFocusConfiguration20 Focus;
    
    public COGEnums.IrCutFilterMode IrCutFilter;
    
    public Float Sharpness;
    
    public COGWideDynamicRange20 WideDynamicRange;
    
    public COGWhiteBalance20 WhiteBalance;
    
    public COGImagingSettingsExtension20 Extension;
    ...
    protected boolean loadProperty(PropertyInfo info,SoapObject soapObject,COGExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if (info.name.equals("BacklightCompensation"))
        {
            if(obj!=null)
            {
                ...
                this.BacklightCompensation = (COGBacklightCompensation20)__envelope.get(j,COGBacklightCompensation20.class,false);
            }
            return true;
        }
        ...
        if (info.name.equals("Exposure"))
        {
            ...
            {
                java.lang.Object j = obj;
                this.Exposure = (COGExposure20)__envelope.get(j,COGExposure20.class,false);
            }
            return true;
        }
        if (info.name.equals("Focus"))
        {
            ...
            {
                java.lang.Object j = obj;
                this.Focus = (COGFocusConfiguration20)__envelope.get(j,COGFocusConfiguration20.class,false);
            }
            return true;
        }
        ...
        if (info.name.equals("WideDynamicRange"))
        {
            ...
            {
                java.lang.Object j = obj;
                this.WideDynamicRange = (COGWideDynamicRange20)__envelope.get(j,COGWideDynamicRange20.class,false);
            }
            return true;
        }
        if (info.name.equals("WhiteBalance"))
        {
            ...
            {
                java.lang.Object j = obj;
                this.WhiteBalance = (COGWhiteBalance20)__envelope.get(j,COGWhiteBalance20.class,false);
            }
            return true;
        }
        if (info.name.equals("Extension"))
        {
            ...
            {
                java.lang.Object j = obj;
                this.Extension = (COGImagingSettingsExtension20)__envelope.get(j,COGImagingSettingsExtension20.class,false);
            }
            return true;
        }
        return false;
    ...
    public void getPropertyInfo(int propertyIndex, @SuppressWarnings("rawtypes") Hashtable arg1, PropertyInfo info)
    {
        if(propertyIndex==0)
        {
            info.type = COGBacklightCompensation20.class;
        ...
        if(propertyIndex==4)
        {
            info.type = COGExposure20.class;
            info.name = "Exposure";
            info.namespace= "http://www.onvif.org/ver10/schema";
        }
        if(propertyIndex==5)
        {
            info.type = COGFocusConfiguration20.class;
            info.name = "Focus";
            info.namespace= "http://www.onvif.org/ver10/schema";
        }
        if(propertyIndex==6)
        ...
        if(propertyIndex==8)
        {
            info.type = COGWideDynamicRange20.class;
            info.name = "WideDynamicRange";
            info.namespace= "http://www.onvif.org/ver10/schema";
        }
        if(propertyIndex==9)
        {
            info.type = COGWhiteBalance20.class;
            info.name = "WhiteBalance";
            info.namespace= "http://www.onvif.org/ver10/schema";
        }
        if(propertyIndex==10)
        {
            info.type = COGImagingSettingsExtension20.class;
            info.name = "Extension";
            info.namespace= "http://www.onvif.org/ver10/schema";
        }
    }
