...
public class COGIPAddress extends AttributeContainer implements KvmSerializable
{

    
    public COGEnums.IPType Type=COGEnums.IPType.IPv4;
        ...
        if (info.name.equals("Type"))
        {
            if(obj!=null)
            {
                if (obj.getClass().equals(SoapPrimitive.class))
                {
                    ...
                    if(j.toString()!=null)
                    {
                        this.Type = COGEnums.IPType.fromString(j.toString());
                    }
                }
                else if (obj instanceof COGEnums.IPType){
                    this.Type = (COGEnums.IPType)obj;
                }
            }
            return true;
        }
