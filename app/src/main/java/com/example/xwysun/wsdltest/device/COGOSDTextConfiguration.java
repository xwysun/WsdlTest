...
public class COGOSDTextConfiguration extends AttributeContainer implements KvmSerializable
{
    ...
    public COGOSDColor FontColor;
    
    public COGOSDColor BackgroundColor;
    
    public String PlainText;
    
    public COGOSDTextConfigurationExtension Extension;
    
    public Boolean IsPersistentText;
    ...
    public void loadFromSoap(java.lang.Object paramObj,COGExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if (inObj.hasAttribute("IsPersistentText"))
        {	
            java.lang.Object j = inObj.getAttribute("IsPersistentText");
            if (j != null)
            {
                IsPersistentText = new Boolean(j.toString());
            }
        }
    ...
    protected boolean loadProperty(PropertyInfo info,SoapObject soapObject,COGExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if (info.name.equals("FontColor"))
        {
            if(obj!=null)
            {
                ...
                this.FontColor = (COGOSDColor)__envelope.get(j,COGOSDColor.class,false);
            }
            return true;
        }
        if (info.name.equals("BackgroundColor"))
        {
            ...
            {
                java.lang.Object j = obj;
                this.BackgroundColor = (COGOSDColor)__envelope.get(j,COGOSDColor.class,false);
            }
            return true;
        }
        ...
        if (info.name.equals("Extension"))
        {
            ...
            {
                java.lang.Object j = obj;
                this.Extension = (COGOSDTextConfigurationExtension)__envelope.get(j,COGOSDTextConfigurationExtension.class,false);
            }
            return true;
        }
        return false;
    ...
    public void getPropertyInfo(int propertyIndex, @SuppressWarnings("rawtypes") Hashtable arg1, PropertyInfo info)
    {
        ...
        if(propertyIndex==7)
        {
            info.type = COGOSDTextConfigurationExtension.class;
            info.name = "Extension";
            info.namespace= "http://www.onvif.org/ver10/schema";
        }
    }
    ...
    public void getAttributeInfo(int index, AttributeInfo info) {
        if(index==0)
        {
            info.name = "IsPersistentText";
            info.namespace= "";
            if(this.IsPersistentText!=null)
            {
                info.setValue(this.IsPersistentText);
            }
