...
public class COGOnvifVersion extends AttributeContainer implements KvmSerializable
{
        ...
        if (info.name.equals("Major"))
        {
            if(obj!=null)
            {
                if (obj.getClass().equals(SoapPrimitive.class))
                {
                    ...
                    if(j.toString()!=null)
                    {
                        this.Major = Integer.parseInt(j.toString());
                    }
                }
        ...
        if (info.name.equals("Minor"))
        {
            if(obj!=null)
            {
                if (obj.getClass().equals(SoapPrimitive.class))
                {
                    ...
                    if(j.toString()!=null)
                    {
                        this.Minor = Integer.parseInt(j.toString());
                    }
                }
                else if (obj instanceof Integer){
