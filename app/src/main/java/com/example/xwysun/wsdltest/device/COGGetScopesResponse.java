...
public class COGGetScopesResponse extends Vector< COGScope> implements KvmSerializable
{
    ...
    public void loadFromSoap(java.lang.Object inObj,COGExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        for (int i0=0;i0< size;i0++)
        {
            ...
            if (obj!=null && obj instanceof AttributeContainer)
            {
                ...
                COGScope j1= (COGScope)__envelope.get(j,COGScope.class,false);
                add(j1);
            }
        }
}
