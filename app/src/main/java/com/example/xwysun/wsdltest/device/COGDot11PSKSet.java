...
public class COGDot11PSKSet extends AttributeContainer implements KvmSerializable
{
    ...
    public COGDot11PSKSetExtension Extension;
    ...
    protected boolean loadProperty(PropertyInfo info,SoapObject soapObject,COGExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if (info.name.equals("Passphrase"))
        {
            if(obj!=null)
            {
                if (obj.getClass().equals(SoapPrimitive.class))
                {
                    ...
                    if(j.toString()!=null)
                    {
                        this.Passphrase = j.toString();
                    }
                }
                else if (obj instanceof String){
                    this.Passphrase = (String)obj;
                }
            }
            return true;
        }
        if (info.name.equals("Extension"))
        {
            if(obj!=null)
            {
                ...
                this.Extension = (COGDot11PSKSetExtension)__envelope.get(j,COGDot11PSKSetExtension.class,false);
            }
            return true;
        }
        return false;
    ...
    public java.lang.Object getProperty(int propertyIndex) {
        ...
        if(propertyIndex==1)
        {
            return this.Passphrase!=null?this.Passphrase:SoapPrimitive.NullSkip;
        }
        if(propertyIndex==2)
        {
    ...
    public void getPropertyInfo(int propertyIndex, @SuppressWarnings("rawtypes") Hashtable arg1, PropertyInfo info)
    {
        ...
        {
            info.type = PropertyInfo.STRING_CLASS;
            info.name = "Passphrase";
            info.namespace= "http://www.onvif.org/ver10/schema";
        }
        if(propertyIndex==2)
        {
            info.type = COGDot11PSKSetExtension.class;
            info.name = "Extension";
            info.namespace= "http://www.onvif.org/ver10/schema";
        }
    }
