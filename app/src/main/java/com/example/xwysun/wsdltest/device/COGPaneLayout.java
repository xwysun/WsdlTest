...
public class COGPaneLayout extends AttributeContainer implements KvmSerializable
{

    
    public String Pane;
    
    public COGRectangle Area;
    ...
    protected boolean loadProperty(PropertyInfo info,SoapObject soapObject,COGExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if (info.name.equals("Area"))
        {
            if(obj!=null)
            {
                ...
                this.Area = (COGRectangle)__envelope.get(j,COGRectangle.class,false);
            }
            return true;
        }
        return false;
