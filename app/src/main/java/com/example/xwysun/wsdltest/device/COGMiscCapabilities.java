...
public class COGMiscCapabilities extends AttributeContainer implements KvmSerializable
{
    ...
    public void loadFromSoap(java.lang.Object paramObj,COGExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if (inObj.hasAttribute("AuxiliaryCommands"))
        {	
            java.lang.Object j = inObj.getAttribute("AuxiliaryCommands");
            if (j != null)
            {
                AuxiliaryCommands = j.toString();
            }
        }
    ...
    public void getAttributeInfo(int index, AttributeInfo info) {
        if(index==0)
        {
            ...
            {
                info.setValue(this.AuxiliaryCommands);
            }
