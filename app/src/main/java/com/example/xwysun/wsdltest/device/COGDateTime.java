...
public class COGDateTime extends AttributeContainer implements KvmSerializable
{
    ...
    protected boolean loadProperty(PropertyInfo info,SoapObject soapObject,COGExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if (info.name.equals("Time"))
        {
            if(obj!=null)
            {
                ...
                this.Time = (COGTime)__envelope.get(j,COGTime.class,false);
            }
            return true;
        }
        if (info.name.equals("Date"))
        {
            ...
            {
                java.lang.Object j = obj;
                this.Date = (COGDate)__envelope.get(j,COGDate.class,false);
            }
            return true;
        }
        return false;
    ...
    public void getPropertyInfo(int propertyIndex, @SuppressWarnings("rawtypes") Hashtable arg1, PropertyInfo info)
    {
        if(propertyIndex==0)
        {
            info.type = COGTime.class;
            info.name = "Time";
            info.namespace= "http://www.onvif.org/ver10/schema";
        }
        if(propertyIndex==1)
        {
            info.type = COGDate.class;
            info.name = "Date";
            info.namespace= "http://www.onvif.org/ver10/schema";
        }
    }
