...
public class COGRelayOutputSettings extends AttributeContainer implements KvmSerializable
{

    
    public COGEnums.RelayMode Mode=COGEnums.RelayMode.Monostable;
    
    public String DelayTime;
    
    public COGEnums.RelayIdleState IdleState=COGEnums.RelayIdleState.closed;
        ...
        if (info.name.equals("Mode"))
        {
            if(obj!=null)
            {
                if (obj.getClass().equals(SoapPrimitive.class))
                {
                    ...
                    if(j.toString()!=null)
                    {
                        this.Mode = COGEnums.RelayMode.fromString(j.toString());
                    }
                }
                else if (obj instanceof COGEnums.RelayMode){
                    this.Mode = (COGEnums.RelayMode)obj;
                }
            }
            return true;
        }
        ...
        if (info.name.equals("IdleState"))
        {
            if(obj!=null)
            {
                if (obj.getClass().equals(SoapPrimitive.class))
                {
                    ...
                    if(j.toString()!=null)
                    {
                        this.IdleState = COGEnums.RelayIdleState.fromString(j.toString());
                    }
                }
                else if (obj instanceof COGEnums.RelayIdleState){
                    this.IdleState = (COGEnums.RelayIdleState)obj;
                }
            }
            return true;
        }
