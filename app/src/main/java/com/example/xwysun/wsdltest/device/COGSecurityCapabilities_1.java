...
public class COGSecurityCapabilities_1 extends AttributeContainer implements KvmSerializable
{
    ...
    public Integer MaxUserNameLength=0;
    
    public Integer MaxPasswordLength=0;
    ...
    public void loadFromSoap(java.lang.Object paramObj,COGExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        {	
            ...
            if (j != null)
            {
                TLS1_x002E_0 = new Boolean(j.toString());
            }
        }
        ...
        {	
            ...
            if (j != null)
            {
                TLS1_x002E_1 = new Boolean(j.toString());
            }
        }
        ...
        {	
            ...
            if (j != null)
            {
                TLS1_x002E_2 = new Boolean(j.toString());
            }
        }
        ...
        {	
            ...
            if (j != null)
            {
                OnboardKeyGeneration = new Boolean(j.toString());
            }
        }
        ...
        {	
            ...
            if (j != null)
            {
                AccessPolicyConfig = new Boolean(j.toString());
            }
        }
        ...
        {	
            ...
            if (j != null)
            {
                DefaultAccessPolicy = new Boolean(j.toString());
            }
        }
        ...
        {	
            ...
            if (j != null)
            {
                RemoteUserHandling = new Boolean(j.toString());
            }
        }
        ...
        {	
            ...
            if (j != null)
            {
                X_x002E_509Token = new Boolean(j.toString());
            }
        }
        ...
        {	
            ...
            if (j != null)
            {
                SAMLToken = new Boolean(j.toString());
            }
        }
        ...
        {	
            ...
            if (j != null)
            {
                KerberosToken = new Boolean(j.toString());
            }
        }
        ...
        {	
            ...
            if (j != null)
            {
                UsernameToken = new Boolean(j.toString());
            }
        }
        ...
        {	
            ...
            if (j != null)
            {
                HttpDigest = new Boolean(j.toString());
            }
        }
        ...
        {	
            ...
            if (j != null)
            {
                RELToken = new Boolean(j.toString());
            }
        }
        ...
        if (inObj.hasAttribute("MaxUserNameLength"))
        {	
            java.lang.Object j = inObj.getAttribute("MaxUserNameLength");
            if (j != null)
            {
                MaxUserNameLength = Integer.parseInt(j.toString());
            }
        }
        if (inObj.hasAttribute("MaxPasswordLength"))
        {	
            java.lang.Object j = inObj.getAttribute("MaxPasswordLength");
            if (j != null)
            {
                MaxPasswordLength = Integer.parseInt(j.toString());
            }
        }
    ...
    public void getAttributeInfo(int index, AttributeInfo info) {
        ...
        if(index==16)
        {
            info.name = "MaxUserNameLength";
            info.namespace= "";
            if(this.MaxUserNameLength!=null)
            {
                info.setValue(this.MaxUserNameLength);
            }
            
        }
        if(index==17)
        {
            info.name = "MaxPasswordLength";
            info.namespace= "";
            if(this.MaxPasswordLength!=null)
            {
                info.setValue(this.MaxPasswordLength);
            }
