...
public class COGSearchCapabilities extends AttributeContainer implements KvmSerializable
{

    
    public String XAddr;
    
    public Boolean MetadataSearch=false;
    ...
    protected boolean loadProperty(PropertyInfo info,SoapObject soapObject,COGExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if (info.name.equals("MetadataSearch"))
        {
            if(obj!=null)
            {
                if (obj.getClass().equals(SoapPrimitive.class))
                {
                    ...
                    if(j.toString()!=null)
                    {
                        this.MetadataSearch = new Boolean(j.toString());
                    }
                }
                else if (obj instanceof Boolean){
                    this.MetadataSearch = (Boolean)obj;
                }
            }
            return true;
        }
