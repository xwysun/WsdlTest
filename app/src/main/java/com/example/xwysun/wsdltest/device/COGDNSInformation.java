...
public class COGDNSInformation extends AttributeContainer implements KvmSerializable
{
    ...
    public ArrayList< COGIPAddress> DNSFromDHCP =new ArrayList<COGIPAddress >();
    
    public ArrayList< COGIPAddress> DNSManual =new ArrayList<COGIPAddress >();
    
    public COGDNSInformationExtension Extension;
    ...
    protected boolean loadProperty(PropertyInfo info,SoapObject soapObject,COGExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if (info.name.equals("DNSFromDHCP"))
        {
            if(obj!=null)
            {
                ...
                {
                    this.DNSFromDHCP = new java.util.ArrayList< COGIPAddress>();
                }
                java.lang.Object j =obj;
        ...
        if (info.name.equals("Extension"))
        {
            ...
            {
                java.lang.Object j = obj;
                this.Extension = (COGDNSInformationExtension)__envelope.get(j,COGDNSInformationExtension.class,false);
            }
            return true;
        }
        return false;
    ...
    public java.lang.Object getProperty(int propertyIndex) {
        ...
        if(propertyIndex>=1+this.SearchDomain.size() && propertyIndex < 1+this.SearchDomain.size()+this.DNSFromDHCP.size())
        {
            java.lang.Object DNSFromDHCP = this.DNSFromDHCP.get(propertyIndex-(1+this.SearchDomain.size()));
            return DNSFromDHCP!=null?DNSFromDHCP:SoapPrimitive.NullNilElement;
        }
        if(propertyIndex>=1+this.SearchDomain.size()+this.DNSFromDHCP.size() && propertyIndex < 1+this.SearchDomain.size()+this.DNSFromDHCP.size()+this.DNSManual.size())
        {
            java.lang.Object DNSManual = this.DNSManual.get(propertyIndex-(1+this.SearchDomain.size()+this.DNSFromDHCP.size()));
            return DNSManual!=null?DNSManual:SoapPrimitive.NullNilElement;
        }
        if(propertyIndex==1+this.SearchDomain.size()+this.DNSFromDHCP.size()+this.DNSManual.size())
        {
    ...
    public void getPropertyInfo(int propertyIndex, @SuppressWarnings("rawtypes") Hashtable arg1, PropertyInfo info)
    {
        ...
        if(propertyIndex==1+this.SearchDomain.size()+this.DNSFromDHCP.size()+this.DNSManual.size())
        {
            info.type = COGDNSInformationExtension.class;
            info.name = "Extension";
            info.namespace= "http://www.onvif.org/ver10/schema";
        }
    }
