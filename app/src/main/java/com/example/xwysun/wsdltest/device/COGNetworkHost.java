...
public class COGNetworkHost extends AttributeContainer implements KvmSerializable
{

    
    public COGEnums.NetworkHostType Type=COGEnums.NetworkHostType.IPv4;
    ...
    public COGNetworkHostExtension Extension;
    ...
    protected boolean loadProperty(PropertyInfo info,SoapObject soapObject,COGExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if (info.name.equals("Type"))
        {
            if(obj!=null)
            {
                if (obj.getClass().equals(SoapPrimitive.class))
                {
                    ...
                    if(j.toString()!=null)
                    {
                        this.Type = COGEnums.NetworkHostType.fromString(j.toString());
                    }
                }
                else if (obj instanceof COGEnums.NetworkHostType){
                    this.Type = (COGEnums.NetworkHostType)obj;
                }
            }
            return true;
        }
        ...
        if (info.name.equals("DNSname"))
        {
            if(obj!=null)
            {
                if (obj.getClass().equals(SoapPrimitive.class))
                {
                    ...
                    if(j.toString()!=null)
                    {
                        this.DNSname = j.toString();
                    }
                }
                else{
                    this.DNSname = obj.toString();
                }
            }
            return true;
        }
        if (info.name.equals("Extension"))
        {
            if(obj!=null)
            {
                ...
                this.Extension = (COGNetworkHostExtension)__envelope.get(j,COGNetworkHostExtension.class,false);
            }
            return true;
        }
        return false;
    ...
    public java.lang.Object getProperty(int propertyIndex) {
        ...
        if(propertyIndex==3)
        {
            return this.DNSname!=null?this.DNSname:SoapPrimitive.NullSkip;
        }
        if(propertyIndex==4)
        {
    ...
    public void getPropertyInfo(int propertyIndex, @SuppressWarnings("rawtypes") Hashtable arg1, PropertyInfo info)
    {
        ...
        if(propertyIndex==4)
        {
            info.type = COGNetworkHostExtension.class;
            info.name = "Extension";
            info.namespace= "http://www.onvif.org/ver10/schema";
        }
    }
