...
public class COGSecurityCapabilities extends AttributeContainer implements KvmSerializable
{
    ...
    public COGSecurityCapabilitiesExtension Extension;
    ...
    protected boolean loadProperty(PropertyInfo info,SoapObject soapObject,COGExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if (info.name.equals("TLS1.1"))
        {
            if(obj!=null)
            {
                if (obj.getClass().equals(SoapPrimitive.class))
                {
                    ...
                    if(j.toString()!=null)
                    {
                        this.TLS1_x002E_1 = new Boolean(j.toString());
                    }
                }
        ...
        if (info.name.equals("TLS1.2"))
        {
            if(obj!=null)
            {
                if (obj.getClass().equals(SoapPrimitive.class))
                {
                    ...
                    if(j.toString()!=null)
                    {
                        this.TLS1_x002E_2 = new Boolean(j.toString());
                    }
                }
                else if (obj instanceof Boolean){
        ...
        if (info.name.equals("OnboardKeyGeneration"))
        {
            if(obj!=null)
            {
                if (obj.getClass().equals(SoapPrimitive.class))
                {
                    ...
                    if(j.toString()!=null)
                    {
                        this.OnboardKeyGeneration = new Boolean(j.toString());
                    }
                }
                else if (obj instanceof Boolean){
        ...
        if (info.name.equals("AccessPolicyConfig"))
        {
            if(obj!=null)
            {
                if (obj.getClass().equals(SoapPrimitive.class))
                {
                    ...
                    if(j.toString()!=null)
                    {
                        this.AccessPolicyConfig = new Boolean(j.toString());
                    }
                }
                else if (obj instanceof Boolean){
        ...
        if (info.name.equals("X.509Token"))
        {
            if(obj!=null)
            {
                if (obj.getClass().equals(SoapPrimitive.class))
                {
                    ...
                    if(j.toString()!=null)
                    {
                        this.X_x002E_509Token = new Boolean(j.toString());
                    }
                }
                else if (obj instanceof Boolean){
        ...
        if (info.name.equals("SAMLToken"))
        {
            if(obj!=null)
            {
                if (obj.getClass().equals(SoapPrimitive.class))
                {
                    ...
                    if(j.toString()!=null)
                    {
                        this.SAMLToken = new Boolean(j.toString());
                    }
                }
                else if (obj instanceof Boolean){
        ...
        if (info.name.equals("KerberosToken"))
        {
            if(obj!=null)
            {
                if (obj.getClass().equals(SoapPrimitive.class))
                {
                    ...
                    if(j.toString()!=null)
                    {
                        this.KerberosToken = new Boolean(j.toString());
                    }
                }
                else if (obj instanceof Boolean){
        ...
        if (info.name.equals("RELToken"))
        {
            if(obj!=null)
            {
                if (obj.getClass().equals(SoapPrimitive.class))
                {
                    ...
                    if(j.toString()!=null)
                    {
                        this.RELToken = new Boolean(j.toString());
                    }
                }
                else if (obj instanceof Boolean){
        ...
        if (info.name.equals("Extension"))
        {
            if(obj!=null)
            {
                ...
                this.Extension = (COGSecurityCapabilitiesExtension)__envelope.get(j,COGSecurityCapabilitiesExtension.class,false);
            }
            return true;
        }
        return false;
    ...
    public void getPropertyInfo(int propertyIndex, @SuppressWarnings("rawtypes") Hashtable arg1, PropertyInfo info)
    {
        ...
        if(propertyIndex==8)
        {
            info.type = COGSecurityCapabilitiesExtension.class;
            info.name = "Extension";
            info.namespace= "http://www.onvif.org/ver10/schema";
        }
    }
