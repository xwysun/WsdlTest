...
public class COGProfileCapabilities extends AttributeContainer implements KvmSerializable
{
    ...
    protected boolean loadProperty(PropertyInfo info,SoapObject soapObject,COGExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if (info.name.equals("MaximumNumberOfProfiles"))
        {
            if(obj!=null)
            {
                if (obj.getClass().equals(SoapPrimitive.class))
                {
                    ...
                    if(j.toString()!=null)
                    {
                        this.MaximumNumberOfProfiles = Integer.parseInt(j.toString());
                    }
                }
                else if (obj instanceof Integer){
                    this.MaximumNumberOfProfiles = (Integer)obj;
                }
            }
            return true;
        }
