...
public class COGBackupFile extends AttributeContainer implements KvmSerializable
{

    
    public String Name;
    
    public COGAttachmentData Data;
    ...
    protected boolean loadProperty(PropertyInfo info,SoapObject soapObject,COGExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if (info.name.equals("Data"))
        {
            if(obj!=null)
            {
                ...
                this.Data = (COGAttachmentData)__envelope.get(j,COGAttachmentData.class,false);
            }
            return true;
        }
        return false;
