...
public class COGAnalyticsDeviceCapabilities extends AttributeContainer implements KvmSerializable
{
    ...
    public COGAnalyticsDeviceExtension Extension;
    ...
    protected boolean loadProperty(PropertyInfo info,SoapObject soapObject,COGExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if (info.name.equals("RuleSupport"))
        {
            if(obj!=null)
            {
                if (obj.getClass().equals(SoapPrimitive.class))
                {
                    ...
                    if(j.toString()!=null)
                    {
                        this.RuleSupport = new Boolean(j.toString());
                    }
                }
        ...
        if (info.name.equals("Extension"))
        {
            if(obj!=null)
            {
                ...
                this.Extension = (COGAnalyticsDeviceExtension)__envelope.get(j,COGAnalyticsDeviceExtension.class,false);
            }
            return true;
        }
        return false;
    ...
    public java.lang.Object getProperty(int propertyIndex) {
        ...
        if(propertyIndex==1)
        {
            return this.RuleSupport!=null?this.RuleSupport:SoapPrimitive.NullSkip;
        }
        if(propertyIndex==2)
        {
    ...
    public void getPropertyInfo(int propertyIndex, @SuppressWarnings("rawtypes") Hashtable arg1, PropertyInfo info)
    {
        ...
        if(propertyIndex==2)
        {
            info.type = COGAnalyticsDeviceExtension.class;
            info.name = "Extension";
            info.namespace= "http://www.onvif.org/ver10/schema";
        }
    }
