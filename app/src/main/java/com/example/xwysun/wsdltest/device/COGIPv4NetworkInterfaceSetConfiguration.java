...
public class COGIPv4NetworkInterfaceSetConfiguration extends AttributeContainer implements KvmSerializable
{
    ...
    public java.lang.Object getProperty(int propertyIndex) {
        ...
        if(propertyIndex>=1 && propertyIndex < 1+this.Manual.size())
        {
            java.lang.Object Manual = this.Manual.get(propertyIndex-(1));
