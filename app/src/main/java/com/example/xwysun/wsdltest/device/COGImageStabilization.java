...
public class COGImageStabilization extends AttributeContainer implements KvmSerializable
{

    
    public COGEnums.ImageStabilizationMode Mode=COGEnums.ImageStabilizationMode.OFF;
    
    public Float Level;
    
    public COGImageStabilizationExtension Extension;
    ...
    protected boolean loadProperty(PropertyInfo info,SoapObject soapObject,COGExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if (info.name.equals("Mode"))
        {
            if(obj!=null)
            {
                if (obj.getClass().equals(SoapPrimitive.class))
                {
                    ...
                    if(j.toString()!=null)
                    {
                        this.Mode = COGEnums.ImageStabilizationMode.fromString(j.toString());
                    }
                }
                else if (obj instanceof COGEnums.ImageStabilizationMode){
                    this.Mode = (COGEnums.ImageStabilizationMode)obj;
                }
            }
            return true;
        }
        ...
        if (info.name.equals("Extension"))
        {
            if(obj!=null)
            {
                ...
                this.Extension = (COGImageStabilizationExtension)__envelope.get(j,COGImageStabilizationExtension.class,false);
            }
            return true;
        }
        return false;
    ...
    public void getPropertyInfo(int propertyIndex, @SuppressWarnings("rawtypes") Hashtable arg1, PropertyInfo info)
    {
        ...
        if(propertyIndex==2)
        {
            info.type = COGImageStabilizationExtension.class;
            info.name = "Extension";
            info.namespace= "http://www.onvif.org/ver10/schema";
        }
    }
