...
public class COGIPv4NetworkInterface extends AttributeContainer implements KvmSerializable
{

    
    public Boolean Enabled=false;
    
    public COGIPv4Configuration Config;
    ...
    protected boolean loadProperty(PropertyInfo info,SoapObject soapObject,COGExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if (info.name.equals("Config"))
        {
            if(obj!=null)
            {
                ...
                this.Config = (COGIPv4Configuration)__envelope.get(j,COGIPv4Configuration.class,false);
            }
            return true;
        }
        return false;
    ...
    public void getPropertyInfo(int propertyIndex, @SuppressWarnings("rawtypes") Hashtable arg1, PropertyInfo info)
    {
        ...
        if(propertyIndex==1)
        {
            info.type = COGIPv4Configuration.class;
            info.name = "Config";
            info.namespace= "http://www.onvif.org/ver10/schema";
        }
    }
