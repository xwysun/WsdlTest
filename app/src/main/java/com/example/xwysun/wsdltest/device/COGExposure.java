...
public class COGExposure extends AttributeContainer implements KvmSerializable
{

    
    public COGEnums.ExposureMode Mode=COGEnums.ExposureMode.AUTO;
    
    public COGEnums.ExposurePriority Priority=COGEnums.ExposurePriority.LowNoise;
