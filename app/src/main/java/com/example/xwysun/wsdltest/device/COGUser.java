...
public class COGUser extends AttributeContainer implements KvmSerializable
{
    ...
    public COGEnums.UserLevel UserLevel=COGEnums.UserLevel.Administrator;
    
    public COGUserExtension Extension;
    ...
    protected boolean loadProperty(PropertyInfo info,SoapObject soapObject,COGExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if (info.name.equals("UserLevel"))
        {
            if(obj!=null)
            {
                if (obj.getClass().equals(SoapPrimitive.class))
                {
                    ...
                    if(j.toString()!=null)
                    {
                        this.UserLevel = COGEnums.UserLevel.fromString(j.toString());
                    }
                }
                else if (obj instanceof COGEnums.UserLevel){
                    this.UserLevel = (COGEnums.UserLevel)obj;
                }
            }
            return true;
        }
        if (info.name.equals("Extension"))
        {
            if(obj!=null)
            {
                ...
                this.Extension = (COGUserExtension)__envelope.get(j,COGUserExtension.class,false);
            }
            return true;
        }
        return false;
    ...
    public void getPropertyInfo(int propertyIndex, @SuppressWarnings("rawtypes") Hashtable arg1, PropertyInfo info)
    {
        ...
        if(propertyIndex==3)
        {
            info.type = COGUserExtension.class;
            info.name = "Extension";
            info.namespace= "http://www.onvif.org/ver10/schema";
        }
    }
