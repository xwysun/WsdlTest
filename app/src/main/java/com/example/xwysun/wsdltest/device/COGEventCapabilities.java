...
public class COGEventCapabilities extends AttributeContainer implements KvmSerializable
{
        ...
        if (info.name.equals("WSSubscriptionPolicySupport"))
        {
            if(obj!=null)
            {
                if (obj.getClass().equals(SoapPrimitive.class))
                {
                    ...
                    if(j.toString()!=null)
                    {
                        this.WSSubscriptionPolicySupport = new Boolean(j.toString());
                    }
                }
        ...
        if (info.name.equals("WSPullPointSupport"))
        {
            if(obj!=null)
            {
                if (obj.getClass().equals(SoapPrimitive.class))
                {
                    ...
                    if(j.toString()!=null)
                    {
                        this.WSPullPointSupport = new Boolean(j.toString());
                    }
                }
                else if (obj instanceof Boolean){
        ...
        if (info.name.equals("WSPausableSubscriptionManagerInterfaceSupport"))
        {
            if(obj!=null)
            {
                if (obj.getClass().equals(SoapPrimitive.class))
                {
                    ...
                    if(j.toString()!=null)
                    {
                        this.WSPausableSubscriptionManagerInterfaceSupport = new Boolean(j.toString());
                    }
                }
                else if (obj instanceof Boolean){
