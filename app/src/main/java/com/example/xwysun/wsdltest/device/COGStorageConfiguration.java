...
public class COGStorageConfiguration extends COGDeviceEntity implements KvmSerializable
{

    
    public COGStorageConfigurationData Data;
    ...
    protected boolean loadProperty(PropertyInfo info,SoapObject soapObject,COGExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if (info.name.equals("Data"))
        {
            if(obj!=null)
            {
                ...
                this.Data = (COGStorageConfigurationData)__envelope.get(j,COGStorageConfigurationData.class,false);
            }
            return true;
        }
    ...
    public void getPropertyInfo(int propertyIndex, @SuppressWarnings("rawtypes") Hashtable arg1, PropertyInfo info)
    {
        ...
        if(propertyIndex==count+0)
        {
            info.type = COGStorageConfigurationData.class;
            info.name = "Data";
