...
public class COGUserCredential extends AttributeContainer implements KvmSerializable
{
    ...
    public COGUserCredential_Extension Extension;
    ...
    protected boolean loadProperty(PropertyInfo info,SoapObject soapObject,COGExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if (info.name.equals("Extension"))
        {
            if(obj!=null)
            {
                ...
                this.Extension = (COGUserCredential_Extension)__envelope.get(j,COGUserCredential_Extension.class,false);
            }
            return true;
        }
        return false;
    ...
    public void getPropertyInfo(int propertyIndex, @SuppressWarnings("rawtypes") Hashtable arg1, PropertyInfo info)
    {
        ...
        if(propertyIndex==2)
        {
            info.type = COGUserCredential_Extension.class;
            info.name = "Extension";
            info.namespace= "http://www.onvif.org/ver10/device/wsdl";
        }
    }
